...
var constraints = []*lexerTestables{
	...
	{true, "1.0",
		results{{itemXRange, "1.0"}},
	},
	{true, "1.x",
		results{{itemXRange, "1.x"}},
	},
	{true, "*.x",
		results{{itemXRange, "*"}},
	},
	...
	{true, "1.*.2",
		results{{itemXRange, "1.*"}},
	},
	{true, "1.*.x || 1.x.4",
		results{{itemXRange, "1.*"}, {itemRange, "||"}, {itemXRange, "1.x"}},
	},
	{false, "1.*.2-beta",
		results{},
	},
	...
	{false, "<1||",
		results{{itemOperator, "<"}, {itemXRange, "1"}, {itemRange, "||"}},
	},
	{false, "M",
		results{},
	},
